...
[2074377](https://bugs.launchpad.net/cinder/+bug/2074377) for the Quobyte
driver and is based on an upstream bugfix to image_utils. This bugfix has been
backported to releases as old as 2023.2 .

The Epoxy version is a backport of the [upstream master branch
fix](https://review.opendev.org/c/openstack/cinder/+/953966).
